class JewelsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to jewels_path, status: :see_other, notice: "Jewel was successfully destroyed." }
  ...
  private
    ...
    def set_jewel
      @jewel = Jewel.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def jewel_params
      params.expect(jewel: [ :type, :material, :price ])
    end
end
