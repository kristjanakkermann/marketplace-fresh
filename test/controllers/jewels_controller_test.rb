...
class JewelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jewel" do
    assert_difference("Jewel.count") do
      post jewels_url, params: { jewel: { material: @jewel.material, price: @jewel.price, type: @jewel.type } }
    end
  ...
  test "should update jewel" do
    patch jewel_url(@jewel), params: { jewel: { material: @jewel.material, price: @jewel.price, type: @jewel.type } }
